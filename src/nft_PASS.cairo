...
mod SeasonPass {
    ...
    fn constructor(ref self: ContractState, owner: ContractAddress) {
        self.erc721.initializer('Season Pass', 'PASS');
    ...
    impl ExternalImpl of ExternalTrait {
        ...
        fn mintCollectible(
            ...
            // // Set the expiration date for the minted NFT (you can customize this logic)
            // let expiration_length = u64::from(30 * 24 * 60 * 60); // 30 days in seconds
            // let expiration_date = starknet::block_timestamp() + expiration_length;
            // self.src5._set_data(next_token_id, "expirationDate".to_string().into_bytes(), expiration_date.to_le_bytes().to_vec());
        }
